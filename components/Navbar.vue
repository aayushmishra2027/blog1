  ...
  <nav>
    ...
    >
      <a href="/" class="flex items-center">
        ...
        <span class="font-recoleta font-semibold">BloggerZ.Inc</span></a
      >
        ...
        <ul class="mr-5 flex">
          <li class="mr-5">
            <NuxtLink
              ...
              class="flex hover:text-[#9CA3AF] duration-100 items-center"
              to="/"
            >
              Home</NuxtLink
            >
          ...
          <li class="mr-3">
            <NuxtLink
              :class="[$route.path === '/blog' ? 'underline' : '']"
              class="flex hover:text-[#9CA3AF] duration-100 items-center"
              to="/blog"
            >
              Blog</NuxtLink
          ...
          <!-- <li class="mr-3">
            <NuxtLink
              :class="[$route.path === 'snippets' ? 'underline' : '']"
              class="flex hover:text-[#9CA3AF] duration-100 items-center"
              to="/snippets"
            >
              Snippets</NuxtLink
