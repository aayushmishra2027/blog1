...
<template>
  <footer>
    ...
    >
      ...
      <div class="flex">
        <a class="mr-3" target="_blank" href="https://twitter.com/tihunov">
          <IconsTwitter class="w-4 dark:fill-white" />
        </a>
        <a target="_blank" href="https://github.com/Dmytro-Tihunov"
          ><IconsGithub class="w-4 dark:fill-white" />
        </a>
      </div>
    </div>
  </footer>
